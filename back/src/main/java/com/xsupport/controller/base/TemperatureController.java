...
public class  TemperatureController {
    ...
    public ReturnCode add(@RequestBody Temperature temperature) {
        if(temperature == null){
...
/*
    ...
    public ReturnCode deleteBySelect(@RequestParam List<String> ids) {
        ...
        temperatureService.deleteByIds(ids);
        return new ReturnCode.Builder().success().msg("删除成功").build();
    }
*/
    ...
    public ReturnCode update(@RequestBody Temperature temperature) {
        if(temperature == null){
            return new ReturnCode.Builder().failed().msg("输入为空").build();
        }
	...
	public ReturnCode detail(@RequestParam String id) {
	    ...
	    return new ReturnCode.Builder().object(temperature).success().msg("查询成功").build();
	}
