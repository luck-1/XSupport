...
public class  DisplacementGroupController {
    ...
    public ReturnCode add(@RequestBody DisplacementGroup displacementGroup) {
        if(displacementGroup == null){
            return new ReturnCode.Builder().failed().msg("输入为空").build();
        }
        displacementGroupService.save(displacementGroup);
    ...
    public ReturnCode delete(@RequestParam String id) {
	    ...
	    displacementGroupService.deleteById(id);
...
/*
    ...
    public ReturnCode deleteBySelect(@RequestParam List<String> ids) {
        ...
        displacementGroupService.deleteByIds(ids);
        return new ReturnCode.Builder().success().msg("删除成功").build();
    }
*/
    ...
    public ReturnCode update(@RequestBody DisplacementGroup displacementGroup) {
        if(displacementGroup == null){
            return new ReturnCode.Builder().failed().msg("输入为空").build();
        }
	    displacementGroupService.update(displacementGroup);
	...
	public ReturnCode detail(@RequestParam String id) {
	    ...
	    DisplacementGroup displacementGroup = displacementGroupService.findById(id);
    ...
    public ReturnCode list(@RequestParam(defaultValue = "0") Integer page,
        ...
        List<DisplacementGroup> list = displacementGroupService.findAll();
